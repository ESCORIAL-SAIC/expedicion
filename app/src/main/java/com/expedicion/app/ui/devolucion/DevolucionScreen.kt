...
fun DevolucionScreen(
    ...
    if (mostrarDialogoEliminar) {
        EliminarEtiquetaDialogDevolucion(
    ...
    ExpScaffold(titulo = "Devolución", onBack = onVolver) { padding ->
...
@Composable
private fun EliminarEtiquetaDialogDevolucion(onConfirmar: (String) -> Unit, onDismiss: () -> Unit) {
