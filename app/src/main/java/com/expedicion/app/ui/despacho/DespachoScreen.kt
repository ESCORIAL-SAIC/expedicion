...
fun DespachoScreen(
    onVolver: () -> Unit,
    viewModel: DespachoViewModel = hiltViewModel(),
) {
    ...
    ExpScaffold(titulo = "Despacho", onBack = onVolver) { padding ->
        Column(modifier = Modifier.fillMaxSize().padding(padding).padding(16.dp)) {
            ...
            Card(
                ...
                Column(Modifier.padding(12.dp)) {
                    ...
                    Row(
                        ...
                        Column {
                            Text("Contador", style = MaterialTheme.typography.labelMedium)
                            Text(uiState.contador.toString(), style = MaterialTheme.typography.titleMedium)
                        }
                    }
                }
            }
            ...
            Row(
                ...
                OutlinedButton(
                    onClick = viewModel::resetContador,
                    shape = RoundedCornerShape(8.dp),
                    modifier = Modifier.weight(1f).height(48.dp),
                ) { Text("Reset contador") }
            }
...
@Composable
private fun EliminarEtiquetaDialog(onConfirmar: (String) -> Unit, onDismiss: () -> Unit) {
    var etiqueta by remember { mutableStateOf("") }
    AlertDialog(
        onDismissRequest = onDismiss,
        title = { Text("Devolución de producto") },
        text = {
            OutlinedTextField(
                value = etiqueta,
